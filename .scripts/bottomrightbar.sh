...
conky -c /home/$USER/.xmonad/conky/bottomright | dzen2 -x $X_POS -y $Y_POS -ta r -fn $FONT -bg $DZEN_BG -w $WIDTH -h $HEIGHT -e 'onnewinput=;button3='
